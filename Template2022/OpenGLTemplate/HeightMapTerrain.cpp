...
bool CHeightMapTerrain::Create(char *terrainFilename, char *textureFilename, glm::vec3 origin, float terrainSizeX, float terrainSizeZ, float terrainHeightScale)
{
	...
	m_texture1.Load("resources\\textures\\dirtpile01.jpg");
	m_texture2.Load("resources\\textures\\TexturesCom_Gravel0141_1_seamless_S.jpg");
	m_texture3.Load("resources\\textures\\TexturesCom_Snow0158_9_seamless_S.jpg");
